...
bitcoin_data = cryptocurrencies_dict["bitcoin"][['Date', 'High']]
ethereum_data = cryptocurrencies_dict["ethereum"][['Date', 'High']]
bitcoincash_data = cryptocurrencies_dict["bitcoincash"][['Date', 'High']]
xrpripple_data = cryptocurrencies_dict["xrpripple"][['Date', 'High']]
litecoin_data = cryptocurrencies_dict["litecoin"][['Date', 'High']]
tether_data = cryptocurrencies_dict["tether"][['Date', 'High']]
...
for ts in dateclose_time_series:
    ...
    title_str = "High price distribution of " + ts
