...
bitcoin_data = cryptocurrencies_dict["bitcoin"][['Date', 'MarketCap']]
ethereum_data = cryptocurrencies_dict["ethereum"][['Date', 'MarketCap']]
bitcoincash_data = cryptocurrencies_dict["bitcoincash"][['Date', 'MarketCap']]
xrpripple_data = cryptocurrencies_dict["xrpripple"][['Date', 'MarketCap']]
litecoin_data = cryptocurrencies_dict["litecoin"][['Date', 'MarketCap']]
tether_data = cryptocurrencies_dict["tether"][['Date', 'MarketCap']]
...
for ts in dateclose_time_series:
    ...
    title_str = "Market Cap distribution of " + ts
