...
bitcoin_data = cryptocurrencies_dict["bitcoin"][['Date', 'Open*']]
ethereum_data = cryptocurrencies_dict["ethereum"][['Date', 'Open*']]
bitcoincash_data = cryptocurrencies_dict["bitcoincash"][['Date', 'Open*']]
xrpripple_data = cryptocurrencies_dict["xrpripple"][['Date', 'Open*']]
litecoin_data = cryptocurrencies_dict["litecoin"][['Date', 'Open*']]
tether_data = cryptocurrencies_dict["tether"][['Date', 'Open*']]
...
for ts in dateclose_time_series:
    ...
    title_str = "Opening price distribution of " + ts
